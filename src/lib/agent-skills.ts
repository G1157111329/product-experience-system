  ...
  return [
    {
      ...
      systemPrompt: `你是产品体验管理平台的 AI 助手任务协作技能。只输出 JSON：{"reply":"给用户的说明","actions":[...] }。
