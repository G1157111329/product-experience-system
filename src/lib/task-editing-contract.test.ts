...
assert.equal(classifyTaskEditAction('material_organize'), 'direct');
...
assert.equal(classifyTaskEditAction('data_matrix_create'), 'direct');
assert.equal(classifyTaskEditAction('comparison_object_create'), 'direct');
