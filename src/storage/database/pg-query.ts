...
import {
  ...
  metricDefinitions,
  metricFormulaVersions,
  metricThresholdRules,
  metricEvaluations,
  comparisonAiResults,
  reportSnapshots,
  matrixSchemas,
  matrixSchemaVersions,
  matrixDimensionBindings,
...
const tableSchemaMap: Record<string, any> = {
  ...
  comparison_assemblies: comparisonAssemblies,
  comparison_objects: comparisonObjects,
  comparison_item_nodes: comparisonItemNodes,
  comparison_matrix_cells: comparisonMatrixCells,
  metric_definitions: metricDefinitions,
  metric_formula_versions: metricFormulaVersions,
  metric_threshold_rules: metricThresholdRules,
  metric_evaluations: metricEvaluations,
  comparison_ai_results: comparisonAiResults,
  report_snapshots: reportSnapshots,
  matrix_schemas: matrixSchemas,
  matrix_schema_versions: matrixSchemaVersions,
  matrix_dimension_bindings: matrixDimensionBindings,
  matrix_formula_definitions: matrixFormulaDefinitions,
  matrix_calculation_runs: matrixCalculationRuns,
  task_matrices: taskMatrices,
  matrix_design_versions: matrixDesignVersions,
  matrix_sections: matrixSections,
  matrix_field_definitions: matrixFieldDefinitions,
  matrix_groups: matrixGroups,
  matrix_rows: matrixRows,
  matrix_field_values: matrixFieldValues,
  matrix_narratives: matrixNarratives,
  pdf_generation_jobs: pdfGenerationJobs,
  excel_import_jobs: excelImportJobs,
  excel_import_templates: excelImportTemplates,
